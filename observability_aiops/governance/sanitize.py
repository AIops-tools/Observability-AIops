...
Consolidated from 22 duplicate ``_sanitize()`` implementations across 7 observability-aiops skills.
...
def sanitize(text: str | None, max_len: int = 500) -> str:
    ...
    Args:
        text: Untrusted text from observability platform API responses.
