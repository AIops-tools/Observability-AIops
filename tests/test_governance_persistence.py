...
compliance evidence is built from actually land on disk. The harness
authorizes nothing: a high-risk write runs and is audited whether or not an
approver annotation is set.
"""
...
def test_high_risk_runs_without_an_approver_and_is_audited(gov_home):
    ...
    result = _drop_widget(name="w2", target="prod-prom")
